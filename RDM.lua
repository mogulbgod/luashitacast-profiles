...
local sets = {
    ['tp_lowacc'] = {
        Main = 'Xiutleato',
        Sub = { Name = 'Genbu\'s Shield', Augment = { [1] = 'HP+3', [2] = '"Cure" spellcasting time -4%', [3] = '"Cure" potency +3%' } },
        Ammo = 'Hedgehog Bomb',
        Head = 'Walahra Turban',
        Neck = 'Chivalrous Chain',
        Ear1 = 'Hollow Earring',
        Ear2 = 'Ethereal Earring',
        Body = { Name = 'Morrigan\'s Robe', Augment = { [1] = 'Accuracy+5', [2] = 'Mag. Acc.+5' } },
        Hands = 'Dusk Gloves',
        Ring1 = 'Rajas Ring',
        Ring2 = 'Strigoi Ring',
...
local settings = {
    ...
    diset = false,
    shield = 'Genbu\'s Shield', -- The preferred shield to use during melee
