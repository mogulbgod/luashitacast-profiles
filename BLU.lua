...
local sets = {
    ...
    ['freeset'] = { -- Best no not have anything here so you can freely change weapons
    },
    ['learningset'] = {
        Main = '',
        Sub = '',
...
local BLUSpellTypeCure      = T{ 'Pollen','Healing Breeze','Wild Carrot','Magic Fruit','Plenilune Embrace' };
...
profile.HandlePrecast = function()
    ...
    --- set midcastdelay -----------
    --------------------------------
    local fastCastValue = FC + 0.02; --- adding fast cast
...
profile.HandleMidcast = function()
    ...
    if (spell.Name == 'Cannonball') then
		--gFunc.EquipSet(sets.cannonball);
        midcastSet = sets.cannonball;
	elseif (spell.Name == 'Asuran Claws') then
		--gFunc.EquipSet(sets.str);
        midcastSet = sets.str;
	elseif (spell.Name == 'Disserverment') then
		--gFunc.EquipSet(sets.str);
        midcastSet = sets.str;
	elseif (spell.Name == 'Magic Hammer') then
    	--gFunc.EquipSet(sets.mnd);
        midcastSet = sets.mnd;
